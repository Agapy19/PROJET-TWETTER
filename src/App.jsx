  ...
  return (
    <>
      <div className="timeline">
        ...
        {/* <img src="Images/cnn-Profile-Photo.png" alt="" /> */}
        ...
        <div className="tweet-content">
          <Tweet p="Gardening boomed during the pandemic. Six Black writers share how it has helped them re-establish, and reimagine, a connection to cultivation and the land.
        " title="The New York Times" reply="19" epingle="48" like="482" />
        </div>
        <Tweet p="Big NEWS lol still Twitter jk" title="Twitter" reply="6.8K" epingle="36.8K" like="267.1K"/>
        <Tweet p="hello litterally everyone" title="Twitter" reply="118.7K" epingle="785.4K" like="3.3M"/>
        <Tweet p="hello litterally everyone" title="Twitter" reply="118.7K" epingle="785.4K" like="3.3M"/>
